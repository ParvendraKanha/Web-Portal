<%@ Page Title="KMPC | Hamlet Master" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Hamlet.aspx.cs" Inherits="Geographical_Hamlet" %>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Hamlet Master</li>
                    </ol>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="card card-primary card-outline">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-7">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="Village" ErrorMessage="Please Enter " ForeColor="#CC3300"></asp:RequiredFieldValidator>
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Hamlet Code<span style="color: red;">*</span></label>
                    <div class="col-sm-10">
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="txtHamletCode" ErrorMessage="Please Enter " ForeColor="#CC3300"></asp:RequiredFieldValidator>
                        <asp:TextBox CssClass="form-control" ID="txtHamletCode" runat="server" AutoPostBack="true" OnTextChanged="txtHamletCode_TextChanged" ></asp:TextBox>
                        <asp:Label ID="lbltxtHamletCode" runat="server" Text="" CssClass="col-sm-2 col-form-label"></asp:Label>

                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label">Hamlet Name<span style="color: red;">*</span></label>
                    <div class="col-sm-10">

                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtHamleteNm" ErrorMessage="Please Enter " ForeColor="#CC3300"></asp:RequiredFieldValidator>
                        <asp:TextBox CssClass="form-control" ID="txtHamleteNm" runat="server" AutoPostBack="true" ></asp:TextBox>
                        <asp:Label ID="lbltxtHamleteNm" runat="server" Text="" CssClass="col-sm-2 col-form-label"></asp:Label>
